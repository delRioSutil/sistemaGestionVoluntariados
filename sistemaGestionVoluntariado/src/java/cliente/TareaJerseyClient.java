...
/**
 * Jersey REST client generated for REST resource:TareaFacadeREST
 * [entidades.tarea]<br>
 * USAGE:
 * <pre>
 ...
 * @author juanr
 */
public class TareaJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/SWvoluntariado/webresources";

    public TareaJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entidades.tarea");
    }
