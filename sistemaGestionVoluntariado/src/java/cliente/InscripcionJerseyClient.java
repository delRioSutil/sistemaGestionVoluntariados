...
/**
 * Jersey REST client generated for REST resource:InscripcionFacadeREST
 * [entidades.inscripcion]<br>
 * USAGE:
 * <pre>
 ...
 * @author Antonio
 */
public class InscripcionJerseyClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:29220/SWvoluntariado/webresources";

    public InscripcionJerseyClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("entidades.inscripcion");
    }
